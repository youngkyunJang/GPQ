...
def PQ_retrieval(sess, x, training_flag, feature, Z, numSeg, train_x, test_x, label_Similarity, TOP_K=50):
    print("Do retrieval")
    pre_index = 0
    test_pre_index = 0
    iteration = 100
    ...
    idxed_descriptor = Indexing(Z, feature, numSeg)
    ...
    Z_np = sess.run(Z)
    quantizedDist = pqDist(Z_np, numSeg, gallery_x, query_x).T
